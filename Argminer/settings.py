"""
Django settings for Argminer project.
...
SECRET_KEY = 'django-insecure-)09-yme-%tle2p*prk2*b#03o&x^&n1n)#-g8n8)u&9fbkjq9w'
...
WSGI_APPLICATION = 'Argminer.wsgi.application'
